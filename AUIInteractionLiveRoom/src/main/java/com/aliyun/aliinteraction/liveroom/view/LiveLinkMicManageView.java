 ...
 * @version 2021/7/29
 */
public class LiveLinkMicManageView extends FrameLayout implements ComponentHolder {

    private final Component component = new Component();
    private final TextView counter;

    public LiveLinkMicManageView(@NonNull Context context) {
        this(context, null, 0);
    }

    public LiveLinkMicManageView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LiveLinkMicManageView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
