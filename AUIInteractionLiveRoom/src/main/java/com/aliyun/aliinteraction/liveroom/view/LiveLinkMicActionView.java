...
import com.aliyun.aliinteraction.liveroom.helper.ExpandShrinkAnimationHelper;
 ...
 * @version 2022/11/15
 */
public class LiveLinkMicActionView extends LinearLayout implements ComponentHolder {
    ...
    public LiveLinkMicActionView(Context context) {
        this(context, null, 0);
    }

    public LiveLinkMicActionView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LiveLinkMicActionView(final Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private class Component extends BaseComponent {
        ...
        public void applyLinkMic() {
            ...
            liveContext.getMessageService().applyJoinLinkMic(liveContext.getLiveModel().anchorId, new Callback<String>() {
                @Override
